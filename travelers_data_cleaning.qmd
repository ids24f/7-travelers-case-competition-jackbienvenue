...
Now, let's attempt our data cleaning using a function defined in the source code for the specific cleaning of this dataset.
...
clean_training_df.to_csv('data/clean_training_data.csv')
clean_test_df.to_csv('data/clean_testing_data.csv')
```